...
#define LCD_RS    (PTB_NUM|9)    //LCD复位
#define LCD_DC    (PTE_NUM|0)    //LCD数据/命令
#define LCD_SCK   (PTB_NUM|3)    //LCD时钟
#define LCD_SDI   (PTB_NUM|5)    //LCD主出从入
#define LCD_CS    (PTE_NUM|1)    //模拟SPI的CS

#define LCD_SPI    SPI_3
